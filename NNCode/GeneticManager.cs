...
public class GeneticManager : MonoBehaviour
{
    ...
    private void FillPopulationWithRandomValues (NNet[] newPopulation, int startingIndex)
    {
        ...
        {
            newPopulation[startingIndex] = gameObject.AddComponent<NNet>();
    ...
    private void Crossover (NNet[] newPopulation)
    {
        for (int i = 0; i < numberToCrossover; i+=2)
        {
            ...
            NNet Child1 = gameObject.AddComponent<NNet>();
            NNet Child2 = gameObject.AddComponent<NNet>();
    ...
    {
        System.Array.Sort(population, delegate (NNet x, NNet y) { return y.fitness.CompareTo(x.fitness); });
    }
